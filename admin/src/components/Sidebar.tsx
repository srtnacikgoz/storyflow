...
// AI İçerik Üretimi menü item'ları
      ...
      <nav className="space-y-1">
        {menuItems.map((item) => (
          <NavLink
            ...
            to={item.path}
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors duration-200 ${isActive
                ? "bg-brand-blue/20 text-gray-900 font-medium"
        ...
        <nav className="space-y-1">
          {orchestratorItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors duration-200 ${isActive
                  ? "bg-brand-mustard/20 text-gray-900 font-medium"
                  : "text-gray-600 hover:bg-gray-100"
                }`
              }
            >
