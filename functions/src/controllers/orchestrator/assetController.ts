 ...
 */
export const listAssets = createHttpFunction(async (request, response) => {
 ...
 * Yeni asset ekle
 */
export const createAsset = createHttpFunction(async (request, response) => {
 ...
 * Asset güncelle
 */
export const updateAsset = createHttpFunction(async (request, response) => {
 ...
 */
export const deleteAsset = createHttpFunction(async (request, response) => {
 ...
 */
export const uploadAssetToCloudinary = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).json({ success: false, error: "Use POST" });
    return;
  }
