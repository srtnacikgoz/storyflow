 ...
 */
export const listThemes = createHttpFunction(async (request, response) => {
 ...
 * Yeni tema oluştur
 */
export const createTheme = createHttpFunction(async (request, response) => {
 ...
 * Tema güncelle
 */
export const updateTheme = createHttpFunction(async (request, response) => {
 ...
 */
export const deleteTheme = createHttpFunction(async (request, response) => {
 ...
 */
export const generateThemeDescription = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).json({ success: false, error: "Use POST" });
    return;
  }
