 ...
 */
export const getCategories = createHttpFunction(async (request, response) => {
 ...
 */
export const getCategoryByType = createHttpFunction(async (request, response) => {
 ...
 */
export const getSubTypeSlugs = createHttpFunction(async (request, response) => {
  const type = request.query.type as string;
 ...
 */
export const getAllProductSlugs = createHttpFunction(async (request, response) => {
 ...
 */
export const getCategorySummary = createHttpFunction(async (request, response) => {
 ...
 */
export const addSubType = createHttpFunction(async (request, response) => {
 ...
 */
export const updateSubType = createHttpFunction(async (request, response) => {
 ...
 * Body: { type, slug }
 */
export const deactivateSubType = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 * Body: { type, slug }
 */
export const activateSubType = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 * Body: { type, slug }
 */
export const deleteSubType = createHttpFunction(async (request, response) => {
 ...
 */
export const reorderSubTypes = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 * POST /seedCategories
 */
export const seedCategories = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 */
export const clearCache = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 */
export const getDisplayName = createHttpFunction(async (request, response) => {
  const type = request.query.type as string;
 ...
 */
export const addMainCategory = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 */
export const updateMainCategory = createHttpFunction(async (request, response) => {
  if (request.method !== "PUT" && request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 * Body: { type }
 */
export const deleteMainCategory = createHttpFunction(async (request, response) => {
 ...
 */
export const getSubTypeById = createHttpFunction(async (request, response) => {
 ...
 */
export const getSubTypeIds = createHttpFunction(async (request, response) => {
  const type = request.query.type as string;
 ...
 */
export const getSubTypeIdBySlug = createHttpFunction(async (request, response) => {
  const type = request.query.type as string;
  const slug = request.query.slug as string;
 ...
 */
export const validateSubTypeId = createHttpFunction(async (request, response) => {
  const id = request.query.id as string;
 ...
 */
export const migrateCategoriesToIdBased = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 */
export const migrateAssetsToIdBased = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 */
export const migrateTimeSlotRulesToIdBased = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
 ...
 */
export const runFullMigration = createHttpFunction(async (request, response) => {
  if (request.method !== "POST") {
    response.status(405).send("Method Not Allowed");
    return;
  }
