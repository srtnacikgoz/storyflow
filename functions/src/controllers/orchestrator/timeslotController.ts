 ...
 */
export const listTimeSlotRules = createHttpFunction(async (request, response) => {
 ...
 */
export const createTimeSlotRule = createHttpFunction(async (request, response) => {
 ...
 */
export const updateTimeSlotRule = createHttpFunction(async (request, response) => {
 ...
 * Zaman kuralı sil
 */
export const deleteTimeSlotRule = createHttpFunction(async (request, response) => {
