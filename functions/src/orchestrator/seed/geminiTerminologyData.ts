...
export const COMPOSITION_TEMPLATES: Record<string, unknown>[] = [
  ...
  // ========== YENİ ÇEKİM MODLARI ==========
  {
    ...
    nameEn: "Single Product Showcase",
    entryPoint: "center",
    angleDescription: "isolated product, clean backdrop, no props",
    productPlacement: "dead center, occupying 50-70% of frame",
    propsPlacement: "none — product only, no table items",
    negativeSpace: "even distribution, soft gradient or solid backdrop",
    geminiTerms: [
    ...
    geminiPrompt:
      "Single product isolated on clean, uncluttered backdrop. No plates, no cups, no table props. Product occupies 50-70% of frame. Soft even lighting, studio-quality. All attention on product form, texture, and color. Professional e-commerce showcase quality.",
    aspectRatio: "4:5",
    bestFor: ["e-commerce", "product-launch", "catalog", "showcase"],
    isActive: true,
    sortOrder: 11,
  },
  {
    name: "Makro Doku Detay",
    nameEn: "Macro Texture Detail",
    entryPoint: "center",
    angleDescription: "extreme close-up, f/1.8 shallow DOF, texture study",
    productPlacement: "filling 85-95% of frame with product surface detail",
    propsPlacement: "none — pure texture focus",
    negativeSpace: "minimal, natural bokeh falloff at edges",
    geminiTerms: [
      "macro photography",
      "extreme close-up",
    ...
    geminiPrompt:
      "Extreme close-up macro shot focusing on product surface texture. Shallow depth of field (f/1.8) creating beautiful bokeh falloff. Product fills 85-95% of frame. Every pore, layer, and surface detail visible. No props, no background elements. Pure texture study with professional lighting.",
    aspectRatio: "4:5",
    bestFor: ["texture", "craftsmanship", "detail", "quality-showcase"],
    isActive: true,
    sortOrder: 12,
  },
  {
    name: "İçecek Hero",
    nameEn: "Beverage Hero",
    entryPoint: "center",
    angleDescription: "cup/glass as hero, eye-level or slight above",
    productPlacement: "beverage container centered, occupying 40-60% of frame",
    propsPlacement: "surface visible, optional drinkware accessories",
    negativeSpace: "20-30% top for steam space or atmosphere",
    geminiTerms: [
      "beverage hero shot",
      "coffee photography",
      "drink focus",
    ...
    geminiPrompt:
      "Beverage as the absolute hero. Cup or glass centered in frame at eye-level or slightly above. Surface texture visible beneath. For hot beverages: gentle warmth suggested through atmosphere. For cold beverages: condensation droplets on glass surface. Professional drink photography with beautiful light passing through or reflecting off the liquid.",
    aspectRatio: "4:5",
    bestFor: ["coffee", "beverages", "drink-menu", "cafe-content"],
    isActive: true,
    sortOrder: 13,
  },
  {
    name: "Çikolata Lüks",
    nameEn: "Chocolate Luxury",
    entryPoint: "center",
    angleDescription: "moody dark backdrop, premium chocolate aesthetic",
    productPlacement: "center or slight off-center, 40-60% of frame",
    propsPlacement: "dark surface only, minimal or none",
    negativeSpace: "deep shadows framing the product",
    geminiTerms: [
      "moody chocolate photography",
      "dark backdrop",
      "luxury aesthetic",
      "premium chocolate presentation",
    ],
    geminiPrompt:
      "Moody dark backdrop with chocolate as luxurious hero. Deep shadows creating premium atmosphere. Specular highlights on tempered chocolate surface. Dark slate or black surface. Rim lighting revealing glossy finish and snap texture. Rich, indulgent, sophisticated aesthetic. Professional chocolate photography.",
    aspectRatio: "4:5",
    bestFor: ["chocolate", "luxury", "premium", "gourmet"],
    isActive: true,
    sortOrder: 14,
  },
  {
    ...
    nameEn: "Catalog Shot",
    entryPoint: "center",
    angleDescription: "pure white/neutral background, studio lighting, standard framing",
    productPlacement: "centered, occupying 50-65% of frame, standard catalog framing",
    propsPlacement: "none — pure product on clean background",
    negativeSpace: "even white/neutral space on all sides",
    geminiTerms: [
      "catalog photography",
    ...
    geminiPrompt:
      "Clean catalog-style product photography on pure white or neutral background. Even studio lighting from multiple softboxes. No shadows on background. Product perfectly centered with standard catalog framing. Print-ready quality. Professional commercial photography suitable for menus, catalogs, and product listings.",
    aspectRatio: "4:5",
    bestFor: ["catalog", "menu", "print", "e-commerce", "listing"],
    isActive: true,
    sortOrder: 15,
  },
];
